...
const CSV_URL = 'https://docs.google.com/sheets/d/e/2PACX-1vQgdVEXfEdmf6_S-HREgfIyhrFulhEsDs_Dz0C_SQDizqbSzGuWlkdlAvLyVcUlUc4zzDKmRUPVSD33/pub?gid=1024027397&single=true&output=csv';
...
function createDoughnutChart(canvasId, labels, data, colors) {
    ...
    // O Chart.js precisa ser registrado com o plugin datalabels globalmente
    // Presume-se que o script do plugin foi adicionado no index.html
    ...
    const chartConfig = {
        ...
        options: {
            // CORREÇÃO PARA MELHORAR O FOCO E RESOLUÇÃO (anti-aliasing)
            responsive: false, // O layout agora é controlado puramente pelo CSS
            devicePixelRatio: 2, // Força a renderização em 2x para gráficos mais nítidos
            maintainAspectRatio: true, // Mantém a proporção 1:1, crucial para doughnuts
            
            plugins: {
                legend: {
                    position: 'bottom', // Move a legenda para baixo
                    labels: {
                        color: '#3E3E3E', // Cor do texto da legenda (--font-color)
                        font: {
                            family: 'Inter, sans-serif'
                        },
                        // AJUSTE 2: Define o estilo do ponto da legenda como círculo
                        usePointStyle: true, 
                        pointStyle: 'circle'
                    }
                },
                ...
                // AJUSTE 1: Configuração do plugin de Data Labels para mostrar valores nas fatias
                datalabels: {
                    ...
                    // Posiciona o rótulo dentro da fatia (metade da distância do centro)
                    anchor: 'center', 
                    align: 'center',
                }
            }
