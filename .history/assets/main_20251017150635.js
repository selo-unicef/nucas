...
const CSV_URL =
  "https://docs.google.com/spreadsheets/d/e/2PACX-1vTPqiRFxht-An0D4qkvXOddlecVuv0LIE1gOEEq93MBwYuFgtaa3pfrvg67s0ZhXsEpvMxgaMz77U1/pub?gid=1024027397&single=true&output=csv";

// Variável global para armazenar os dados processados (resumos)
// ESSA É A VARIÁVEL SOLICITADA PELO USUÁRIO, agora com o tipo 'const'
...
async function loadAndProcessData() {
  try {
    ...
    // Ponto de acesso para verificar o dicionário no console
    console.log("Dados Processados armazenados:", DADOS_PROCESSADOS);
