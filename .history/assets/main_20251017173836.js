...
const BRAZIL_STATES_GEOJSON_URL =
  "https://raw.githubusercontent.com/fititnt/gis-brasil-states-cities/master/states/geojson/br_states.geojson";
...
function carregarMapbox(nucaDataByUF) {
  ...
  const colorStops = [
      0, '#75B4CC', // Para contagem 0, use a cor mais clara
      minCount, '#75B4CC', // Mínimo
